var createMediapipeSolutionsWasm = ( () => {
    ...
    return (function(createMediapipeSolutionsWasm) {
        ...
        var JsValStore = {
            ...
            add: function(js_val) {
                ...
                do {
                    ...
                    if (JsValStore.next_id > 2147483647)
                        JsValStore.next_id = 1
        ...
        function writeI53ToI64(ptr, num) {
            ...
            if (deserialized != num)
                warnOnce("writeI53ToI64() out of range: serialized JS Number " + num + " to Wasm heap as bytes lo=" + ptrToString(HEAPU32[ptr >> 2]) + ", hi=" + ptrToString(HEAPU32[ptr + 4 >> 2]) + ", which deserializes back to " + deserialized + " instead!")
        }
        ...
        function _wgpuCommandEncoderBeginComputePass(encoderId, descriptor) {
            ...
            if (descriptor) {
                ...
                if (labelPtr)
                    desc["label"] = UTF8ToString(labelPtr);
        ...
        function _wgpuQueueWriteBuffer(queueId, bufferId, bufferOffset_low, bufferOffset_high, data, size) {
            ...
            var bufferOffset = (assert(bufferOffset_high < 2097152),
